...
const SECRET_ASSIGNMENT =
  /(?:^|[^A-Za-z0-9_])(?:(?:[A-Za-z0-9]+_)*(?:password|passwd|secret|token)(?:_[A-Za-z0-9]+)*|(?:[A-Za-z0-9_]+_)?api[_-]?key|[a-z][a-zA-Z0-9]*(?:Password|Secret|Token|ApiKey)|apiKey|clientSecret|dbPassword)\b\s*[:=]\s*(?:(['"])([^'"]+)\1|([^\s'";,)]+))/i;
